...
from .views import department, attendance, dayoff, payroll, position
...
urlpatterns = [
    ...
    path('position/<str:position_title>/employee/all/', position.EmployeesPositionListView.as_view(), name='position-employee-list')
]
